                                ...
                                <div class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="growthReportId"
                                            id="jobDropdownMenu"style="max-height: 300px; overflow-y: auto;">
...
const lastMonthApplicants = currentMonth > 0 ? (monthlyData[currentMonth - 1] || 0) : 0;

let growth;

// ✨ Smarter UX logic
if (thisMonthApplicants === 0) {
  growth = 0; // Show 0% if no data yet this month
} else if (lastMonthApplicants === 0) {
  growth = 100; // If last month empty and now we have applicants → 100% growth
} else {
...
console.log("This month applicants:", thisMonthApplicants);
console.log("Last month applicants:", lastMonthApplicants);
...
if (growthChart) {
  growthChart.updateOptions({
    series: [growth <= 0 ? 0 : growth], // 🔥 Never 0 or negative
    colors: [growth >= 0 ? '#696cff' : '#ff4c51'] // 🔵 blue or 🔴 red
  });
}
