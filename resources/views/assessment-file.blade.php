...
<section class="site-section">
  <div class="container">
    ...
    <form class="p-4 p-md-5 border rounded bg-light" method="post" enctype="multipart/form-data">
      {{-- Assessment Instructions --}}
      <div class="mb-4">
        <h4 class="mb-3">Instructions</h4>
        <div class="small" style="font-size: 0.95rem;">
          <p>Silakan baca file instruksi yang diberikan dan unggah dokumen hasil kerja Anda dalam format PDF atau DOCX.</p>
          <ul>
