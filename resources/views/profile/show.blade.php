...
<div class="d-flex justify-content-between align-items-center">
    ...
    <a href="{{ route('userprofile.edit') }}" title="Edit Profile">
                    ...
                    <div class="tab-content p-4">
                        ...
                        <div class="tab-pane active show" id="projects-tab" role="tabpanel">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="{{ route('projects.edit') }}" title="Edit Projects">
                                    <i class="mdi mdi-pencil edit-icon"></i>
                                </a>
                            </div>
                            <div class="row">
                        ...
                        <div class="tab-pane" id="experience-tab" role="tabpanel">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="{{ route('experience.edit') }}" title="Edit Experience">
                                    <i class="mdi mdi-pencil edit-icon"></i>
                                </a>
                            </div>
                            <div class="row">
                        ...
                        <div class="tab-pane" id="achievements-tab" role="tabpanel">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="{{ route('achievements.edit') }}" title="Edit Achievements">
                                    <i class="mdi mdi-pencil edit-icon"></i>
                                </a>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center pb-2">
                            ...
                            {{-- User profile edit link can also be here if preferred --}}
                            {{-- <a href="{{ route('userprofile.edit') }}" title="Edit Profile">
                            <i class="mdi mdi-pencil edit-icon"></i>
                        </a> --}}
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('skills.edit') }}" title="Edit Skills">
                                <i class="mdi mdi-pencil edit-icon"></i>
                            </a>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('profile.edit') }}" title="Edit Skills">
                                <i class="mdi mdi-pencil edit-icon"></i>
                            </a>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('education.edit') }}" title="Edit Education">
                                <i class="mdi mdi-pencil edit-icon"></i>
                            </a>
                        </div>
