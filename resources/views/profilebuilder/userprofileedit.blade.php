...
@section('step-title', 'Edit Basic Info')
@section('step-desc', 'Update your personal and professional information.')
...
<form method="POST" action="{{ route('userprofile.update') }}" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    ...
    @if ($profile->cv_url)
      <small class="text-muted">Current: <a href="{{ asset('storage/' . $profile->cv_url) }}" target="_blank">View CV</a></small>
    @endif
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="file" id="profile_picture_input" class="form-control" accept="image/*">
    <input type="hidden" name="profile_picture_cropped" id="profile_picture_cropped">
    <div class="mt-3">
      <img id="profile-picture-preview" class="rounded-circle border" style="max-width: 150px;" 
